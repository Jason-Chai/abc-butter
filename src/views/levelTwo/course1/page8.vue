  ...
  <div class="main">
    ...
    <div class="bg-div">
      ...
      <div class="page2-content">
        <div class="content">
            <!-- <div class=""><img src="../../../assets/images/commonImg/p8-img1.png"/></div> -->
            <div class="content-left">
              <div class="each-pic" ref="sentenceMain" @click="beginMusicAndEnd('sentenceMain', 0)">
                <img src="../../../assets/images/commonImg/p8-img2.png">
              </div>
            </div>
            <div class="content-right">
              <div class="pic-sentence"  @click="beginMusicAndEnd('sentenceMain', 0)">
                <img src="../../../assets/images/commonImg/p8-img3.png">
              </div>
              <div class="play-buttons">
                  <span class="page5Play page5Play1" @click="beginMusicAndEnd('play',0)"></span>
                  <span class="page5Play page5Play2" @click="beginMusicAndEnd('play',1)"></span>
              </div>
            </div>
        </div>
      </div>
...
<script>
  import VueAudio from "../../../components/talkToClownMenu";
  export default {
    name: "",
    components: {
      VueAudio
...
<style lang="less" scoped>
  ...
  @import "../../../assets/css/talktoClown";
  @rem: 128rem;
  .content {
       position: relative;
       .scale(1129, 538);
       .pos-a(187, 145, 3);
       background: url('../../../assets/images/commonImg/p8-img1.png') no-repeat;
       background-size: cover;
      .content-left {
        position: absolute;
        left: 48 / @rem !important;
        top: 60 / @rem;
        .each-pic {
          width: 277 / @rem;
          img {
