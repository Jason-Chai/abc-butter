 ...
 * @LastEditTime: 2019-09-26 18:36:24
...
<template>
  <div class="main">
    <div class="bg-div">
      <div class="canvas">
        <div class="canvasMain">
         <div :class="AAbounceIn2 == true&&AbounceIn == true?'AAbounceIn2':''">
           <img ref="appleLetterListA" @click="beginMusicAndEnd('A','A')"  class="thisIsA" :class="AbounceIn == true?'AbounceIn':''" src="../../../assets/images/pL/pageB.png" alt />
           </div>
          <div :class="aasbounceIn2 == true&&abounceIns == true?'aasbounceIn2':''">
            <img ref="appleLetterListaa" @click="beginMusicAndEnd('aa','aa')"  class="thisIsA1" :class="abounceIns == true?'abounceIns':''" src="../../../assets/images/pL/pagebb.png" alt />
            </div>
        </div>
      </div>
      ...
      <div class="xiong">
        <img src="../../../assets/images/xiong/B/p2.png" alt />
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    let playTime = window.setTimeout(() => {
      // that.$refs.audios.changeCurrentTime(4.6);
