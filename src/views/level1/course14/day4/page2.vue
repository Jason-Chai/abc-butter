              ...
              <vuedraggable tag="li" class="curBaseTr" v-model="appleLetter1" v-bind="option1" :move="move">
                <transition-group>
                  <li class="move" :key="'answer1'" :id="'answer1'">
                    <!-- 正确答案2  -->
                    <img v-if="answer1" src="../../../../assets/images/level1/course14/day4-p2-img1.png" alt>
                  </li>
                </transition-group>
              </vuedraggable>
              <vuedraggable tag="li" class="curBaseTr" v-model="appleLetter2" v-bind="option1" :move="move">
                <transition-group>
                  <li class="move" :key="'answer2'" :id="'answer2'">
                    <!-- 正确答案1  -->
                    <img v-if="answer2" src="../../../../assets/images/level1/course14/day4-p2-img2.png" alt>
                  </li>
                </transition-group>
              </vuedraggable>
              <vuedraggable tag="li" class="curBaseTr" v-model="appleLetter3" v-bind="option1" :move="move">
                <transition-group>
                  <li class="move" :key="'answer3'" :id="'answer3'">
                    <!-- 正确答案3  -->
                    <img v-if="answer3" src="../../../../assets/images/level1/course14/day4-p2-img3.png" alt>
                  </li>
                </transition-group>
              </vuedraggable>
              <vuedraggable tag="li" class="curBaseTr" v-model="appleLetter4" v-bind="option1" :move="move">
                <transition-group>
                  <li class="move" :key="'answer4'" :id="'answer4'">
                    <!-- 正确答案4  -->
                    <img v-if="answer4" src="../../../../assets/images/level1/course14/day4-p2-img4.png" alt>
                  </li>
                </transition-group>
              </vuedraggable>
            </div>
            ...
            <vuedraggable class="content-main-bottom" @end="end" v-model="appleLetter" v-bind="option" :move="move">
              <transition-group>
                ...
                <li v-if="!answer3" :key="'answer3'" :id="'answer3'">
                  <img src="../../../../assets/images/level1/course14/day4-p2-img3.png" alt>
                </li>
                 <li v-if="!answer1" :key="'answer1'" :id="'answer1'">
                  <img src="../../../../assets/images/level1/course14/day4-p2-img1.png" alt>
                </li>
                <li v-if="!answer4" :key="'answer4'" :id="'answer4'">
                  <img src="../../../../assets/images/level1/course14/day4-p2-img4.png" alt>
                </li>
                <li v-if="!answer2" :key="'answer2'" :id="'answer2'">
                  <img src="../../../../assets/images/level1/course14/day4-p2-img2.png" alt>
                </li>
              </transition-group>
            </vuedraggable>
          </div>
...
<style lang="less" scoped>
  ...
  .content-main-left {
    .item {
        ...
        height: 45 / @rem;
        display: block;
        background: url("../../../../assets/images/level1/course14/day4-p2-sText.png") no-repeat;
        background-size: 269 / @rem 225 / @rem;
        cursor: pointer;
        &.item1 {
