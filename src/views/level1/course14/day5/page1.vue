    ...
    <div class="div-bg">
      ...
      <div class="page2-content">
        <div class="content">
          ...
          <span class="item item1" :class="{active:activeIndex==0}" ref="text1"></span>
          <span class="item item2" :class="{active:activeIndex==1}" ref="text2"></span>
          <span class="item item3" :class="{active:activeIndex==2}" ref="text3"></span>
          <span class="item item4" :class="{active:activeIndex==3}" ref="text4"></span>
          <span class="item item5" :class="{active:activeIndex==4}" ref="text5"></span>
          <span class="item item6" :class="{active:activeIndex==5}" ref="text6"></span>
          <span class="item item7" :class="{active:activeIndex==6}" ref="text7"></span>
          <span class="item item8" :class="{active:activeIndex==7}" ref="text8"></span>
          <!-- <span class="item item10" :class="{active:activeIndex==8}" ref="text10"></span>
          <span class="item item11" :class="{active:activeIndex==9}" ref="text11"></span>
          <span class="item item12" :class="{active:activeIndex==10}" ref="text12"></span>
          <span class="item item13" :class="{active:activeIndex==11}" ref="text13"></span> -->
  ...
  export default {
    ...
    data() {
      return {
        ...
        value1: 50,
        audiosMusicUrlDefault: "./static/mp3/level1/level1-14.mp3",
        audios: {
        ...
        menuList: [ //右侧菜单
          {
            routerUrl: 'L1Course14Day5Page1',
            imgSrc: require('../../../../assets/images/commonImg/menu/theme-sing-menu-sing.png')
          },
          {
            routerUrl: 'L1Course14Day5Page2',
            imgSrc: require('../../../../assets/images/commonImg/menu/theme-sing-menu-sent.png')
          },
          {
            routerUrl: 'L1Course14Day5Page3',
            imgSrc: require('../../../../assets/images/commonImg/menu/theme-sing-menu-listenchoose.png')
          },
          {
        ...
        songList: [{
            ...
            audiosMusicUrl: "./static/mp3/level1/level1-14-song.mp3",
            beginTime: 0, //歌曲开始时间
            endTime: 42, //歌曲结束时间
            endLyric: 42 //歌词结束时间
          },
          {
            ...
            audiosMusicUrl: "./static/mp3/level1/level1-14-instrumental.mp3",
            beginTime: 0,
            endTime: 42,
            endLyric: 42
          }
        ...
        playerOptions: {
          ...
          sources: [{
            type: "video/mp4",
            src: "./static/mp4/level1-14.mp4" //你的视频地址（必填）
          }],
          poster: "", //你的封面地址
  ...
  .div-bg {
    .page2-content {
      .content {
        ...
        .itemMain {
          background: url("../../../../assets/images/level1/course14/day5-p1-sText.png") no-repeat;
          background-size: 915/@rem 525/@rem;
        }
        .itemTitle {
          .itemMain;
          width: 650/@rem;
        ...
        .item {
          ...
          .loop(@counter) when (@counter > 0) {
              .loop((@counter - 1));
              &.item@{counter} {
                  background-position-y:-(96-54+54*@counter)/@rem;
              }
          }
          .loop(8);

          &.active {
            background-position-x: -486/@rem;
          }
