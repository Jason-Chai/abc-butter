    ...
    <div class="bg-div">
      ...
      <div class="page2-content">
        <div class="content" v-show="showQuestionItem===0">
          ...
          <div class="mainPic">
            <img src="../../../../assets/images/level1/course8/day3-p2-img1.png" alt>
          </div>
        ...
        <div class="content" v-show="showQuestionItem===1">
          ...
          <div class="mainPic">
            <img src="../../../../assets/images/level1/course8/day3-p2-img2.png" alt>
          </div>
         ...
         <div class="content" v-show="showQuestionItem===2">
          ...
          <div class="mainPic">
            <img src="../../../../assets/images/level1/course8/day3-p2-img3.png" alt>
          </div>
         ...
         <div class="content" v-show="showQuestionItem===3">
            ...
            <div class="mainPic">
              <img src="../../../../assets/images/level1/course8/day3-p2-img4.png" alt>
            </div>
