      ...
      <div class="page2-content">
        <div class="content">
          <div ref="word1" @click="beginMusicAndEnd('word1', 1)" class="each-pic pic1">
            <img src="../../../../assets/images/level1/course8/day5-p2-img1.png" alt>
          </div>
          <div ref="word2" @click="beginMusicAndEnd('word2', 2)" class="each-pic pic2">
            <img src="../../../../assets/images/level1/course8/day5-p2-img2.png" alt>
          </div>
        </div>
      </div>
    </div>
      ...
      menuList:[//右侧菜单
          {
            ...
            imgSrc:require('../../../../assets/images/commonImg/menu/theme-vocan-menu-sing.png')
          },
           {
