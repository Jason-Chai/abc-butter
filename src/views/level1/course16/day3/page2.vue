    ...
    <div class="bg-div">
      ...
      <div class="page2-content">
        <div class="content-left">
          <img src="../../../../assets/images/level1/course16/day3-p2-title.png" class="title" />
        ...
        <div class="content-right">
          <div ref="word2" class="each-pic pic2" @click="beginMusicAndEnd('right',0)">
            <img src="../../../../assets/images/level1/course16/day3-p2-img2.png" alt>
          </div>
          <div ref="word5" class="each-pic pic5" @click="beginMusicAndEnd('wrong',0)">
            <img src="../../../../assets/images/level1/course16/day3-p2-img5-wrong.png" alt>
          </div>
          <div ref="word3" class="each-pic pic3" @click="beginMusicAndEnd('right',0)">
            <img src="../../../../assets/images/level1/course16/day3-p2-img3.png" alt>
          </div>
          <div ref="word4" class="each-pic pic4" @click="beginMusicAndEnd('right',0)">
            <img src="../../../../assets/images/level1/course16/day3-p2-img4.png" alt>
          </div>
          <div ref="word6" class="each-pic pic6" @click="beginMusicAndEnd('wrong',0)">
            <img src="../../../../assets/images/level1/course16/day3-p2-img6-wrong.png" alt>
          </div>
          <div ref="word1" class="each-pic pic1" @click="beginMusicAndEnd('right',0)">
            <img src="../../../../assets/images/level1/course16/day3-p2-img1.png" alt>
          </div>
        </div>
      </div>
    </div>
...
<style lang="less" scoped>
  ...
  .main {
    .animate-bg {
      .scale(308, 519);
      .pos-a(505, 112, 3);
      background: url("../../../../assets/images/level1/course16/ani-day3-p2.png") no-repeat;
