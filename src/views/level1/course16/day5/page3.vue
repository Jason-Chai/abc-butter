      ...
      return {
        ...
        menuList: [ //右侧菜单
          ...
          },
          {
            ...
            imgSrc: require('../../../../assets/images/commonImg/menu/theme-sing-menu-lookorder.png')
          },
          {
        ...
        songList: [{
            ...
            audiosMusicUrl: "./static/mp3/level1/level1-16-song.mp3",
            beginTime: 0, //歌曲开始时间
            endTime: 19.1, //歌曲结束时间
            endLyric: 19.1 //歌词结束时间
          },
          {
            songTime: [{
                id: "songItem1",
            ...
            audiosMusicUrl: "./static/mp3/level1/level1-16-instrumental.mp3",
            beginTime: 0, //歌曲开始时间
            endTime: 19.1, //歌曲结束时间
            endLyric: 19.1 //歌词结束时间
          }
        ...
        playerOptions: {
          ...
          sources: [{
            type: "video/mp4",
            src: "./static/mp4/level1-16.mp4" //你的视频地址（必填）
          }],
          poster: "", //你的封面地址
  ...
  .div-bg {
    .page2-content {
      .content {
        ...
        .itemMain {
          background: url("../../../../assets/images/level1/course16/day5-p3-sText.png") no-repeat;
          background-size: 894/@rem 527/@rem;
        }
