              ...
              <vuedraggable tag="li" class="curBaseTr" v-model="appleLetter1" v-bind="option1" :move="move">
                <transition-group>
                  <li class="move" :key="'answer1'" :id="'answer1'">
                    <!-- 正确答案2  -->
                    <img v-if="answer1" src="../../../../assets/images/level1/course16/day5-p2-img1.png" alt>
                  </li>
                </transition-group>
              </vuedraggable>
              <vuedraggable tag="li" class="curBaseTr" v-model="appleLetter2" v-bind="option1" :move="move">
                <transition-group>
                  <li class="move" :key="'answer2'" :id="'answer2'">
                    <!-- 正确答案1  -->
                    <img v-if="answer2" src="../../../../assets/images/level1/course16/day5-p2-img2.png" alt>
                  </li>
                </transition-group>
              </vuedraggable>
              <vuedraggable tag="li" class="curBaseTr" v-model="appleLetter3" v-bind="option1" :move="move">
                <transition-group>
                  <li class="move" :key="'answer3'" :id="'answer3'">
                    <!-- 正确答案3  -->
                    <img v-if="answer3" src="../../../../assets/images/level1/course16/day5-p2-img3.png" alt>
                  </li>
                </transition-group>
              </vuedraggable>
              <vuedraggable tag="li" class="curBaseTr" v-model="appleLetter4" v-bind="option1" :move="move">
                <transition-group>
                  <li class="move" :key="'answer4'" :id="'answer4'">
                    <!-- 正确答案4  -->
                    <img v-if="answer4" src="../../../../assets/images/level1/course16/day5-p2-img4.png" alt>
                  </li>
                </transition-group>
              </vuedraggable>
              <vuedraggable tag="li" class="curBaseTr" v-model="appleLetter5" v-bind="option1" :move="move">
                <transition-group>
                  <li class="move" :key="'answer5'" :id="'answer5'">
                    <!-- 正确答案5  -->
                    <img v-if="answer5" src="../../../../assets/images/level1/course16/day5-p2-img5.png" alt>
                  </li>
                </transition-group>
              </vuedraggable>
              <vuedraggable tag="li" class="curBaseTr" v-model="appleLetter6" v-bind="option1" :move="move">
                <transition-group>
                  <li class="move" :key="'answer6'" :id="'answer6'">
                    <!-- 正确答案6  -->
                    <img v-if="answer6" src="../../../../assets/images/level1/course16/day5-p2-img6.png" alt>
                  </li>
                </transition-group>
              </vuedraggable>
            </div>
            <vuedraggable class="content-main-bottom" @end="end" v-model="appleLetter" v-bind="option" :move="move">
              <transition-group>
                <li v-if="!answer4" :key="'answer4'" :id="'answer4'">
                  <img src="../../../../assets/images/level1/course16/day5-p2-img4.png" alt>
                </li>
                <li v-if="!answer5" :key="'answer5'" :id="'answer5'">
                  <img src="../../../../assets/images/level1/course16/day5-p2-img5.png" alt>
                </li>
                <li v-if="!answer6" :key="'answer6'" :id="'answer6'">
                  <img src="../../../../assets/images/level1/course16/day5-p2-img6.png" alt>
                </li>
                <li v-if="!answer1" :key="'answer1'" :id="'answer1'">
                  <img src="../../../../assets/images/level1/course16/day5-p2-img1.png" alt>
                </li>
                <li v-if="!answer2" :key="'answer2'" :id="'answer2'">
                  <img src="../../../../assets/images/level1/course16/day5-p2-img2.png" alt>
                </li>
                <li v-if="!answer3" :key="'answer3'" :id="'answer3'">
                  <img src="../../../../assets/images/level1/course16/day5-p2-img3.png" alt>
                </li>
              </transition-group>
            </vuedraggable>
          </div>
    ...
    data() {
      return {
        ...
        menuList: [
          //右侧菜单
          {
            routerUrl: 'L1Course16Day5Page1',
            imgSrc: require('../../../../assets/images/commonImg/menu/theme-lookorder-menu-voca.png')
          },
          {
            routerUrl: 'L1Course16Day5Page2',
            imgSrc: require('../../../../assets/images/commonImg/menu/theme-lookorder-menu-lookorder.png')
          },
          {
            routerUrl: 'L1Course16Day5Page3',
            imgSrc: require('../../../../assets/images/commonImg/menu/theme-lookorder-menu-sing.png')
          },
          {
        ...
        playlist: ["text1", "text2", "text3", "text4", "text5", "text6"],
        musicTimeList: {
          text1: {
            beginTime: 325.4,
            endTime: 1.5
...
<style lang="less" scoped>
  ...
  .content-main-left {
    .item {
      ...
      height: 46 / @rem;
      display: block;
      background: url("../../../../assets/images/level1/course16/day5-p2-sText.png") no-repeat;
      background-size: 128/@rem 348/@rem;
      cursor: pointer;

      &.item1 {
        background-position: 0 -(62*0) / @rem;
        margin-left: 0;
      }
      &.item2 {
        background-position: 0 -(62*1) / @rem;
      }
      &.item3 {
        background-position: 0 -(62*2) / @rem;
      }
      &.item4 {
        background-position: 0 -(62*3) / @rem;
      }
      &.item5 {
        background-position: 0 -(62*4) / @rem;
      }
      &.item6 {
        background-position: 0 -(62*5) / @rem;
      }
    }
