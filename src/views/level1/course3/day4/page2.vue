    ...
    <div class="bg-div">
      ...
      <div class="page2-content">
        <div class="content-left">
              <img src="../../../../assets/images/level1/course3/day4-p2-title.png" class="title" @click="beginMusicAndEnd('btn1')"/>
        ...
        <div class="content-right">
          <div ref="word1" class="each-pic pic1" @click="beginMusicAndEnd('right',0)">
            <img src="../../../../assets/images/level1/course3/day4-p2-img1-wrong.png" alt>
          </div>
          <div ref="word2" class="each-pic pic2" @click="beginMusicAndEnd('right',0)">
            <img src="../../../../assets/images/level1/course3/day4-p2-img2-wrong.png" alt>
          </div>
           <div ref="word3" class="each-pic pic3" @click="beginMusicAndEnd('right',0)">
            <img src="../../../../assets/images/level1/course3/day4-p2-img3-wrong.png" alt>
          </div>
           <div ref="word4" class="each-pic pic4" @click="beginMusicAndEnd('right',0)">
            <img src="../../../../assets/images/level1/course3/day4-p2-img4.png" alt>
          </div>
...
<style lang="less" scoped>
  ...
  .main {
    .animate-bg {
      .scale(293, 535);
      .pos-a(515, 108, 3);
      background: url("../../../../assets/images/level1/course3/day4-p2-person.png") no-repeat;
      background-size: auto 535 / @rem;
      pointer-events: none;
    }
  ...
  .page2-content {
    ...
    .content-right{
      ...
      // width: 1040/@rem !important; //六个个 宽
      width: 940/@rem !important; //四个个 宽
    }
    .each-pic {
      // 两个大小
      // width: 434 / @rem;
