  ...
  export default {
    ...
    data() {
      return {
        ...
        value1: 50,
        audiosMusicUrlDefault: "./static/mp3/level1/level1-11.mp3",
        audios: {
        ...
        songList: [{
            ...
            audiosMusicUrl: "./static/mp3/level1/level1-13-song.mp3",
            beginTime: 0, //歌曲开始时间
            endTime: 27, //歌曲结束时间
            endLyric: 20 //歌词结束时间
          },
          {
            ...
            audiosMusicUrl: "./static/mp3/level1/level1-13-instrumental.mp3",
            beginTime: 0,
            endTime: 27,
            endLyric: 20
          }
        ...
        playerOptions: {
          ...
          sources: [{
            type: "video/mp4",
            src: "./static/mp4/level1-13.mp4" //你的视频地址（必填）
          }],
          poster: "", //你的封面地址
  ...
  .div-bg {
    .page2-content {
      .content {
        ...
        .itemMain {
          background: url("../../../../assets/images/level1/course13/day5-p1-sText.png") no-repeat;
          background-size: 1384/@rem 394/@rem;
        }
        .itemTitle {
          .itemMain;
          width: 581/@rem;
        ...
        .item {
          ...
          .loop(@counter) when (@counter > 0) {
              .loop((@counter - 1));
              &.item@{counter} {
                  background-position-y:-(90-51+51*@counter)/@rem;
              }
          }
          .loop(6);

          &.active {
            background-position-x: -828/@rem;
          }
