  ...
  export default {
    ...
    data() {
      return {
        ...
        value1: 50,
        audiosMusicUrlDefault: "./static/mp3/level1/level1-02.mp3",
        audios: {
        ...
        songList: [{
            ...
            audiosMusicUrl: "./static/mp3/level1/level1-02-song.mp3",
            beginTime: 0, //歌曲开始时间
            endTime: 43.3, //歌曲结束时间
            endLyric: 29.2 //歌词结束时间
          },{
            songTime: [{
                id: "songItem1",
                beginTime: 9.5
            ...
            audiosMusicUrl: "./static/mp3/level1/level1-02-instrumental.mp3",
            beginTime: 0, //歌曲开始时间
            endTime: 43.3, //歌曲结束时间
            endLyric: 29.2 //歌词结束时间
          }
        ...
        playerOptions: {
          ...
          sources: [{
            type: "video/mp4",
            src: "./static/mp4/level1-02.mp4" //你的视频地址（必填）
          }],
          poster: "", //你的封面地址
    ...
    .page2-content {
      .content {
        .itemTitle {
          width: 425/@rem;
          height: 60/@rem;
          background: url("../../../../assets/images/level1/course2/day5-p1-sText.png") no-repeat;
