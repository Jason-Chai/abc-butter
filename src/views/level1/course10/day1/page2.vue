      ...
      <div class="content">
        <div class="content-left">
          <div class="each-pic pic-sentence" ref="sentenceMain" @click="beginMusicAndEnd('sentenceMain', 0)">
            <img src="../../../../assets/images/level1/course10/day1-p2-juzi.png">
          </div>
        </div>
        <div class="content-right">
          <div class="item item1" ref="sentence1">
            <span class="pic">
              <img src="../../../../assets/images/level1/course10/day1-p2-img1.png">
            </span>
            <span class="text" :style="{'display':showText1 ? 'block':'none'}">
              <img src="../../../../assets/images/level1/course10/day1-p2-img1b.png">
            </span>
          </div>
          <div class="item item2" ref="sentence2">
            <span class="pic">
              <img src="../../../../assets/images/level1/course10/day1-p2-img2.png">
            </span>
            <span class="text" :style="{'display':showText2 ? 'block':'none'}">
              <img src="../../../../assets/images/level1/course10/day1-p2-img2b.png">
            </span>
          </div>
          <div class="item item3" ref="sentence3">
            <span class="pic">
              <img src="../../../../assets/images/level1/course10/day1-p2-img3.png">
            </span>
            <span class="text" :style="{'display':showText3 ? 'block':'none'}">
              <img src="../../../../assets/images/level1/course10/day1-p2-img3b.png">
            </span>
          </div>
          <div class="item item4" ref="sentence4">
            <span class="pic">
              <img src="../../../../assets/images/level1/course10/day1-p2-img4.png">
            </span>
            <span class="text" :style="{'display':showText4 ? 'block':'none'}">
              <img src="../../../../assets/images/level1/course10/day1-p2-img4b.png">
            </span>
          </div>
        </div>
      </div>
      ...
      return {
        ...
        menuList: [
          //右侧菜单
          {
            ...
            imgSrc: require('../../../../assets/images/commonImg/menu/theme-sent-menu-sing.png')
          },
          {
          ...
          },
          {
            ...
            imgSrc: require('../../../../assets/images/commonImg/menu/theme-sent-menu-picture.png')
          },
          {
