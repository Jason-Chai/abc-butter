      ...
      return {
        ...
        menuList: [ //右侧菜单
          ...
          },
          {
            ...
            imgSrc: require("../../../../assets/images/commonImg/menu/theme-sing-menu-picture.png")
          },
          {
        ...
        songList: [{
            ...
            audiosMusicUrl: "./static/mp3/level1/level1-10-song.mp3",
            beginTime: 0, //歌曲开始时间
            endTime: 19.2, //歌曲结束时间
            endLyric: 15.8 //歌词结束时间
          },
          {
            songTime: [{
                id: "songItem1",
            ...
            audiosMusicUrl: "./static/mp3/level1/level1-10-instrumental.mp3",
            beginTime: 0, //歌曲开始时间
            endTime: 19.2, //歌曲结束时间
            endLyric: 15.8 //歌词结束时间
          }
        ...
        playerOptions: {
          ...
          sources: [{
            type: "video/mp4",
            src: "./static/mp4/level1-10.mp4" //你的视频地址（必填）
          }],
          poster: "", //你的封面地址
  ...
  .div-bg {
    .page2-content {
      .content {
        ...
        .itemMain {
          background: url("../../../../assets/images/level1/course10/day1-p1-sText.png") no-repeat;
          background-size: 716/@rem 360/@rem;
        }
        ...
        .item {
          ...
          .loop(@counter) when (@counter > 0) {
            ...
            &.item@{counter} {
              background-position-y: -(80-56+56*@counter)/@rem;
            }
          }
