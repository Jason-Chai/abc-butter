    ...
    data() {
      return {
        ...
        songList: [{
            ...
            audiosMusicUrl: "./static/mp3/level1/level1-05-song.mp3",
            beginTime: 0, //歌曲开始时间
            endTime: 59, //歌曲结束时间
            endLyric: 54.4 //歌词结束时间
          },{
            songTime: [{
                id: "songItem1",
                beginTime: 7
            ...
            audiosMusicUrl: "./static/mp3/level1/level1-05-instrumental.mp3",
            beginTime: 0, //歌曲开始时间
            endTime: 59, //歌曲结束时间
            endLyric: 54.4 //歌词结束时间
          }
        ...
        playerOptions: {
          ...
          sources: [{
            type: "video/mp4",
            src: "./static/mp4/level1-05.mp4" //你的视频地址（必填）
          }],
          poster: "", //你的封面地址
    ...
    .page2-content {
      .content {
        ...
        .itemTitle {
          width: 660/@rem;
          height: 60/@rem;
          background: url("../../../../assets/images/level1/course5/day5-p1-img1.png") no-repeat;
          background-size: 1330/@rem 753/@rem;
