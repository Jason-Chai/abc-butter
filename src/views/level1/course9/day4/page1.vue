      ...
      <div class="content">
        <div class="content-left">
          <div class="each-pic pic-sentence" ref="sentenceMain" @click="beginMusicAndEnd('sentenceMain', 0)">
            <img src="../../../../assets/images/level1/course9/day4-p1-juzi.png">
          </div>
        </div>
        <div class="content-right">
          <div class="item item1" ref="sentence1" @click="beginMusicAndEnd('sentence1', 1)">
            <span class="pic">
              <img src="../../../../assets/images/level1/course9/day4-p1-img1.png">
            </span>
            <span class="text" :style="{'display':showText1 ? 'block':'none'}">
              <img src="../../../../assets/images/level1/course9/day4-p1-img1-b.png">
            </span>
          </div>
          <div class="item item2" ref="sentence2" @click="beginMusicAndEnd('sentence2', 2)">
            <span class="pic">
              <img src="../../../../assets/images/level1/course9/day4-p1-img2.png">
            </span>
            <span class="text" :style="{'display':showText2 ? 'block':'none'}">
              <img src="../../../../assets/images/level1/course9/day4-p1-img2-b.png">
            </span>
          </div>
          <div class="item item3" ref="sentence3" @click="beginMusicAndEnd('sentence3', 3)">
            <span class="pic">
              <img src="../../../../assets/images/level1/course9/day4-p1-img3.png">
            </span>
            <span class="text" :style="{'display':showText3 ? 'block':'none'}">
              <img src="../../../../assets/images/level1/course9/day4-p1-img3-b.png">
            </span>
          </div>
          <div class="item item4" ref="sentence4" @click="beginMusicAndEnd('sentence4', 4)">
            <span class="pic">
              <img src="../../../../assets/images/level1/course9/day4-p1-img4.png">
            </span>
            <span class="text" :style="{'display':showText4 ? 'block':'none'}">
              <img src="../../../../assets/images/level1/course9/day4-p1-img4-b.png">
            </span>
          </div>
        </div>
      </div>
