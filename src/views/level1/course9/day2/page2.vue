  ...
  export default {
    ...
    data() {
      return {
        ...
        menuList: [
          {
            routerUrl: 'L1Course9Day2Page1',
            imgSrc: require('../../../../assets/images/commonImg/menu/theme-voca-menu-sing.png')
          },
          {
            routerUrl: 'L1Course9Day2Page2',
            imgSrc: require('../../../../assets/images/commonImg/menu/theme-voca-menu-voca.png')
          },
          {
            routerUrl: 'L1Course9Day2Page3',
            imgSrc: require('../../../../assets/images/commonImg/menu/theme-voca-menu-lookcircle.png')
          },
          {
