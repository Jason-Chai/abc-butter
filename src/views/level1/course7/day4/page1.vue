    ...
    data() {
      return {
        ...
        menuList: [
          //右侧菜单
           {
            routerUrl: 'L1Course7Day4Page1',
            imgSrc: require('../../../../assets/images/commonImg/menu/theme-sentn-menu-sent.png')
          },
          {
            routerUrl: 'L1Course7Day4Page2',
            imgSrc: require('../../../../assets/images/commonImg/menu/theme-sentn-menu-torf.png')
          },
          {
