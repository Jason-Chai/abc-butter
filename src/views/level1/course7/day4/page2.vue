    ...
    <div class="bg-div">
      ...
      <div class="page2-content">
        <div class="content" v-show="showQuestionItem===0">
          ...
          <div class="mainPic">
            <img src="../../../../assets/images/level1/course7/day4-p2-img1.png" alt>
          </div>
        ...
        <div class="content" v-show="showQuestionItem===1">
          ...
          <div class="mainPic">
            <img src="../../../../assets/images/level1/course7/day4-p2-img2.png" alt>
          </div>
         ...
         <div class="content" v-show="showQuestionItem===2">
          ...
          <div class="mainPic">
            <img src="../../../../assets/images/level1/course7/day4-p2-img3.png" alt>
          </div>
          <div class="playBtn" ref="btn3" @click="beginMusicAndEnd('btn3')"></div>
        </div>
         <div class="content" v-show="showQuestionItem===3">
            <div class="yes" @click="selectAnswer('yes',3)"></div>
            <div class="no" @click="selectAnswer('no',3)"></div>
            <div class="mainPic">
              <img src="../../../../assets/images/level1/course7/day4-p2-img4.png" alt>
            </div>
            <div class="playBtn" ref="btn4" @click="beginMusicAndEnd('btn4')"></div>
        </div>
         <div class="content" v-show="showQuestionItem===4">
            <div class="yes" @click="selectAnswer('yes',4)"></div>
            <div class="no" @click="selectAnswer('no',4)"></div>
            <div class="mainPic">
              <img src="../../../../assets/images/level1/course7/day4-p2-img5.png" alt>
            </div>
            <div class="playBtn" ref="btn5" @click="beginMusicAndEnd('btn5')"></div>
        </div>
      </div>
    </div>
  </div>
