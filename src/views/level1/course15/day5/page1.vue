    ...
    data() {
      return {
        ...
        songList: [{
            ...
            audiosMusicUrl: "./static/mp3/level1/level1-15-song-2.mp3",
            beginTime: 0, //歌曲开始时间
            endTime: 55.6, //歌曲结束时间
            endLyric: 55.6 //歌词结束时间
          },
          {
            songTime: [{
                id: "songItem1",
            ...
            audiosMusicUrl: "./static/mp3/level1/level1-15-instrumental-2.mp3",
            beginTime: 0, //歌曲开始时间
            endTime: 55.6, //歌曲结束时间
            endLyric: 55.6 //歌词结束时间
          }
        ...
        playerOptions: {
          ...
          sources: [{
            type: "video/mp4",
            src: "./static/mp4/level1-15.mp4" //你的视频地址（必填）
          }],
          poster: "", //你的封面地址
  ...
  .div-bg {
    .page2-content {
      .content {
        ...
        .itemMain {
          background: url("../../../../assets/images/level1/course15/day5-p1-sText.png") no-repeat;
          background-size: 1418/@rem 753/@rem;
        }
