    ...
    data() {
      return {
        ...
        songList: [{
            ...
            audiosMusicUrl: "./static/mp3/level1/level1-15-song.mp3",
            beginTime: 0, //歌曲开始时间
            endTime: 19.1, //歌曲结束时间
          ...
          },
          {
            ...
            audiosMusicUrl: "./static/mp3/level1/level1-15-instrumental.mp3",
            beginTime: 0, //歌曲开始时间
            endTime: 19.1, //歌曲结束时间
            endLyric: 19.1 //歌词结束时间
          }
  ...
  .div-bg {
    .page2-content {
      .content {
        ...
        .itemMain {
          background: url("../../../../assets/images/level1/course15/day4-p1-sText.png") no-repeat;
          background-size: 872/@rem 527/@rem;
        }
