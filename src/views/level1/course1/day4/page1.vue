  ...
  export default {
    ...
    data() {
      return {
        ...
        value1: 50,
        audiosMusicUrlDefault: "./static/mp3/level1/level1-01.mp3",
        audios: {
        ...
        songList: [{
            ...
            audiosMusicUrl: "./static/mp3/level1/level1-01-song.mp3",
            beginTime: 0, //歌曲开始时间
            endTime: 23, //歌曲结束时间
            endLyric: 22 //歌词结束时间
          },{
            ...
            audiosMusicUrl: "./static/mp3/level1/level1-01-instrumental.mp3",
            beginTime: 0, //歌曲开始时间
            endTime: 23, //歌曲结束时间
            endLyric: 22 //歌词结束时间
          }
        ...
        playerOptions: {
          ...
          sources: [{
            type: "video/mp4",
            src: "./static/mp4/level1-01.mp4" //你的视频地址（必填）
          }],
          poster: "", //你的封面地址
    ...
    .page2-content {
      .content {
        .itemTitle {
          width: 425/@rem;
          height: 60/@rem;
          background: url("../../../../assets/images/level1/course1/day4-p1-sText.png") no-repeat;
          background-size: 1170/@rem 529/@rem;
        ...
        .loop(@n, @i: 1) when (@i =< @n) {
          .item@{i} {
            background-position-y:-(40+56*@i)/@rem;
          }
          .loop(@n, (@i+1));
        }
      }
