  ...
  export default {
    ...
    data() {
      return {
        ...
        value1: 50,
        audiosMusicUrlDefault: "./static/mp3/level1/level1-12.mp3",
        audios: {
        ...
        songList: [{
            ...
            audiosMusicUrl: "./static/mp3/level1/level1-12-song.mp3",
            beginTime: 0, //歌曲开始时间
            endTime: 43.2, //歌曲结束时间
            endLyric: 36 //歌词结束时间
          },
          {
            ...
            audiosMusicUrl: "./static/mp3/level1/level1-12-instrumental.mp3",
            beginTime: 0,
            endTime: 43.2,
            endLyric: 36
          }
        ...
        playerOptions: {
          ...
          sources: [{
            type: "video/mp4",
            src: "./static/mp4/level1-12.mp4" //你的视频地址（必填）
          }],
          poster: "", //你的封面地址
  ...
  .div-bg {
    .page2-content {
      .content {
        ...
        .itemMain {
          background: url("../../../../assets/images/level1/course12/day1-p1-sText.png") no-repeat;
          background-size: 1000/@rem 635/@rem;
        }
        .itemTitle {
          .itemMain;
          width: 450/@rem;
