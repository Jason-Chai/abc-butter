  ...
  export default {
    ...
    data() {
      return {
        ...
        flag: false,
        timerList: [],
        showTextLayer: ["showText1", "showText2", "showText3"],
