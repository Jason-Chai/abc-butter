  ...
  export default {
    ...
    data() {
      return {
        ...
        value1: 50,
        audiosMusicUrlDefault: "./static/mp3/level1/level1-06.mp3",
        audios: {
        ...
        menuList: [ //右侧菜单
          {
            routerUrl: 'L1Course6Day5Page1',
            imgSrc: require('../../../../assets/images/commonImg/menu/theme-sing-menu-sing.png')
          },
          {
            routerUrl: 'L1Course6Day5Page2',
            imgSrc: require('../../../../assets/images/commonImg/menu/theme-sing-menu-sent.png')
          },
          {
            routerUrl: 'L1Course6Day5Page3',
            imgSrc: require('../../../../assets/images/commonImg/menu/theme-sing-menu-torf.png')
          },
          {
        ...
        songList: [{
            ...
            audiosMusicUrl: "./static/mp3/level1/level1-06-song.mp3",
            beginTime: 0, //歌曲开始时间
            endTime: 19.2, //歌曲结束时间
            endLyric: 19.2 //歌词结束时间
          },{
            songTime: [{
                id: "songItem1",
                beginTime: 3.8
            ...
            audiosMusicUrl: "./static/mp3/level1/level1-06-instrumental.mp3",
            beginTime: 0, //歌曲开始时间
            endTime: 19.2, //歌曲结束时间
            endLyric: 19.2 //歌词结束时间
          }
        ...
        playerOptions: {
          ...
          sources: [{
            type: "video/mp4",
            src: "./static/mp4/level1-06.mp4" //你的视频地址（必填）
          }],
          poster: "", //你的封面地址
    ...
    .page2-content {
      .content {
        ...
        .itemTitle {
          width: 660/@rem;
          height: 60/@rem;
          background: url("../../../../assets/images/level1/course6/day5-p1-img1.png") no-repeat;
          background-size: 1131/@rem 527/@rem;
