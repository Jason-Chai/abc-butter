    ...
    <div class="bg-div">
      ...
      <div class="page2-content">
        <div class="content" v-show="showQuestionItem===0">
          ...
          <div class="mainPic">
            <img src="../../../../assets/images/level1/course6/day5-p3-img1.png" alt>
          </div>
        ...
        <!-- <div class="content" v-show="showQuestionItem===1">
          ...
          <div class="mainPic">
            <img src="../../../../assets/images/level1/course6/day5-p2-img2.png" alt>
          </div>
         ...
         <!-- <div class="content" v-show="showQuestionItem===2">
          ...
          <div class="mainPic">
            <img src="../../../../assets/images/level1/course6/day5-p2-img3.png" alt>
          </div>
        ...
        menuList: [ //右侧菜单
          {
            ...
            imgSrc: require('../../../../assets/images/commonImg/menu/theme-torf-menu-sing.png')
          },
          {
