    ...
    data() {
      return {
        ...
        songList: [{
            ...
            audiosMusicUrl: "./static/mp3/level1/level1-11-song.mp3",
            beginTime: 0, //歌曲开始时间
            endTime: 31, //歌曲结束时间
            endLyric: 25 //歌词结束时间
          },
          {
            ...
            audiosMusicUrl: "./static/mp3/level1/level1-11-instrumental.mp3",
            beginTime: 0,
            endTime: 31, //歌曲结束时间
            endLyric: 25 //歌词结束时间
          }
        ...
        playerOptions: {
          ...
          sources: [{
            type: "video/mp4",
            src: "./static/mp4/level1-11.mp4" //你的视频地址（必填）
          }],
          poster: "", //你的封面地址
  ...
  .div-bg {
    .page2-content {
      .content {
        ...
        .itemMain {
          background: url("../../../../assets/images/level1/course11/day3-p1-sText.png") no-repeat;
          background-size: 757/@rem 414/@rem;
        }
        .itemTitle {
          .itemMain;
          width: 600/@rem;
        ...
        .item {
          ...
          .loop(@counter) when (@counter > 0) {
              .loop((@counter - 1));
              &.item@{counter} {
                  background-position-y:-(90-70+70*@counter)/@rem;
              }
          }
          .loop(5);

          &.active {
            background-position-x: -430/@rem;
          }
