<template>
  <div class="di main-wrap numberM">
    ...
    <div class="top-button">
      <a class="refresh" @click="refresh()">
        <img src="../assets/images/replay8.png" alt />
      </a>
      <div class="titleList">
        <img src="../assets/images/lookNumber.png" alt />
      </div>
      <div class="sound">
      ...
      <router-link :to="routerUrl" class="next-button" replace>
        <img src="../assets/images/next8.png" alt />
      </router-link>
      <div class="nav">
        <img class="menu" @click="showNavList" src="../assets/images/menu8.png" alt />
...
.nav {
  ...
  .navList {
      ...
      top: 187 / @rem;
      right: 0;
      background: url(../assets/images/menuBg-number.png) no-repeat;
      ...
      div {
        ...
        height: 84/@rem;
        display: block;
        background: url(../assets/images/menuItemBg-number.png) no-repeat;
        background-size: 100% 100%;
        margin:  0 auto;
        img{
          width: 100%;
...
.top-button {
  ...
  .sound {
    background: url(../assets/images/soundTop-number.png);
