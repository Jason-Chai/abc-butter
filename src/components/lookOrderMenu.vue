  ...
  <div class="di main-wrap orderM">
    ...
    <div class="top-button">
      <a class="refresh" @click="refresh()">
        <img src="../assets/images/replay5.png" alt />
      </a>
      <div class="titleList">
        ...
        <img v-else src="../assets/images/lookOrder.png" alt />
      </div>
      <div class="sound">
        <!-- <div class="audio">
        ...
        <div class="sound-button">
          ...
          <div class="volume" @click="startMutedOrNot">
            <img v-if="audio.muted == true" src="../assets/images/say5-off.png" alt />
            <img v-else src="../assets/images/say5.png" alt />
          </div>
        </div>
      </div>
      <router-link :to="routerUrl" class="next-button" replace>
        <img src="../assets/images/next5.png" alt />
      </router-link>
      <div class="nav">
        <img @click="showNavList" src="../assets/images/menu5.png" class="menu" alt />
...
.nav {
  ...
  .navList {
      ...
      top: 187 / @rem;
      right: 0;
      background: url(../assets/images/menuBg5.png) no-repeat;
      ...
      div {
        ...
        height: 84/@rem;
        display: block;
        // background: url(../assets/images/menuItem5bg.png) no-repeat;
        background-size: 100% 100%;
        margin:  0 auto;
        img{
          width: 100%;
...
.top-button {
  ...
  .sound {
    background: url(../assets/images/soundTop5.png);
