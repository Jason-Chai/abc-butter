<template>
  <div class="di main-wrap sentenceM">
    ...
    <div class="top-button">
      <a class="refresh" @click="refresh()">
        <img src="../assets/images/replay4.png" alt />
      </a>
      <div class="titleList">
        <img v-if="titleCurr == 1" src="../assets/images/sentence-v.png" alt />
      ...
      <div class="sound">
       ...
       <div class="sound-button">
          ...
          <div class="volume" @click="startMutedOrNot">
            <img v-if="audio.muted == true" src="../assets/images/say4-off.png" alt />
            <img v-else src="../assets/images/say4.png" alt />
          </div>
        </div>
      </div>
      <router-link :to="routerUrl" class="next-button" replace>
        <img src="../assets/images/next4.png" alt />
      </router-link>
      <div class="nav">
        <img @click="showNavList" src="../assets/images/menu4.png" class="menu" alt />
...
.nav {
  ...
  .navList {
      ...
      top: 187 / @rem;
      right: 0;
      background: url(../assets/images/menuBg4.png) no-repeat;
      background-size: 100% 100%;
      display: flex;
      flex-direction: column;
      justify-content: space-around;
      padding-top:30/@rem;padding-bottom: 30/@rem;
...
.top-button {
  ...
  .sound {
    background: url(../assets/images/soundTop4.png);
