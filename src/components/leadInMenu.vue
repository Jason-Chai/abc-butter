<template>
  <div class="di main-wrap leadInM">
    ...
    <div class="top-button">
      <a class="refresh" @click="refresh()">
        <img src="../assets/images/replay2.png" alt>
      </a>
      <div class="titleList">
        <img src="../assets/images/leadInT.png" alt>
      </div>
      <div class="sound">
        <div class="sound-button">
          ...
          <div class="volume" @click="startMutedOrNot">
            <img v-if="audio.muted == true" src="../assets/images/say7-off.png" alt>
            <img v-else src="../assets/images/say7.png" alt>
          </div>
        </div>
      </div>
      ...
      <div class="nav">
        <img @click="showNavList" src="../assets/images/menu2.png" alt>
        <div v-show="navListShow"  :class="navListShow ? 'navListOn':'navListOff'" class="navList">
...
.nav {
  ...
  .navList {
    ...
    top: 187 / @rem;
    right: 0;
    background: url(../assets/images/menuBg2.png) no-repeat;
    ...
    div {
      ...
      height: 84/@rem;
      display: block;
      background: url(../assets/images/menuItem2bg.png) no-repeat;
      background-size: 100% 100%;
      margin:  0 auto;
      img{
         width: 100%;
...
.top-button {
  ...
  .sound {
    background: url(../assets/images/soundTop2.png);
