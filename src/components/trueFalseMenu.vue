  ...
  <div class="di main-wrap torfM">
    ...
    <div class="top-button">
      <a class="refresh" @click="refresh()">
        <img src="../assets/images/replay-torf.png" alt />
      </a>
      <div class="titleList">
        <img src="../assets/images/trueFalse.png" alt />
      </div>
      <div class="sound">
        <!-- <div class="audio">
        ...
        <div class="sound-button">
          ...
          <div class="volume" @click="startMutedOrNot">
            <img v-if="audio.muted == true" src="../assets/images/say-torf-off.png" alt />
            <img v-else src="../assets/images/say-torf.png" alt />
          </div>
        </div>
      </div>
      <router-link :to="routerUrl" class="next-button" replace>
        <img src="../assets/images/next-torf.png" alt />
      </router-link>
      <div class="nav">
        <img @click="showNavList" src="../assets/images/menu-torf.png" class="menu" alt />
...
<style lang="less" scoped>
  ...
  .nav {
    ...
    .navList {
      ...
      top: 187 / @rem;
      right: 0;
      background: url(../assets/images/menuBg-torf.png) no-repeat;
      ...
      div {
        ...
        height: 84/@rem;
        display: block;
        background: url(../assets/images/menuItembg-torf.png) no-repeat;
        background-size: 100% 100%;
        margin:  0 auto;
        img{
          width: 100%;
  ...
  .top-button {
    ...
    .sound {
      background: url(../assets/images/soundTop-torf.png);
