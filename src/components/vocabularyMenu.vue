  ...
  <div class="di main-wrap vM">
    ...
    <div class="top-button">
      <a class="refresh" @click="refresh()">
        <img src="../assets/images/replay3.png" alt />
      </a>
      <div class="titleList">
        <img src="../assets/images/VocabularyT.png" alt />
      </div>
      <div class="sound">
        <div class="sound-button">
          ...
          <div class="volume" @click="startMutedOrNot">
            <img v-if="audio.muted == true" src="../assets/images/say3-off.png" alt />
            <img v-else src="../assets/images/say3.png" alt />
          </div>
        </div>
      </div>
      <router-link :to="routerUrl" class="next-button" replace>
        <img src="../assets/images/next3.png" alt />
      </router-link>
      <div class="nav">
        <img @click="showNavList" src="../assets/images/menu3.png" class="menu" alt />
...
<style lang="less" scoped>
  ...
  .nav {
    ...
    .navList {
      ...
      top: 187 / @rem;
      right: 0;
      background: url(../assets/images/menuBg3.png) no-repeat;
      background-size: 100% 100%;
      display: flex;
      flex-direction: column;
      justify-content: space-around;
      padding-top:60/@rem;padding-bottom: 20/@rem;

      div {
        width: 453/@rem;
        height: 84/@rem;
        display: block;
        background: url(../assets/images/menuItem3bg.png) no-repeat;
        background-size: 100% 100%;
        margin:  0 auto;
        img{
          width: 100%;
