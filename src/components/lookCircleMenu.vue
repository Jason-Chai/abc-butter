<template>
  <div class="di main-wrap circleM">
    ...
    <div class="top-button">
      <a class="refresh" @click="refresh()">
        <img src="../assets/images/replay10.png" alt />
      </a>
      <div class="titleList">
        <img  v-if="titleCurr==3" src="../assets/images/lookCircle.png" alt />
        <img  v-if="titleCurr==4" src="../assets/images/listenmatch.png" alt />
      </div>
      <div class="sound">
        <!-- <div class="audio">
         ...
         <div class="sound-button">
          ...
          <div class="volume" @click="startMutedOrNot">
            <img v-if="audio.muted == true" src="../assets/images/say2-off.png" alt />
            <img v-else src="../assets/images/say2.png" alt />
          </div>
        </div>
      </div>
      <router-link :to="routerUrl" class="next-button" replace>
        <img src="../assets/images/next10.png" alt />
      </router-link>
      <div class="nav">
        <img class="menu" @click="showNavList" src="../assets/images/menu10.png" alt />
...
.nav {
  ...
  .navList {
      ...
      top: 187 / @rem;
      right: 0;
      background: url(../assets/images/menuBg10.png) no-repeat;
      ...
      div {
        ...
        height: 84/@rem;
        display: block;
        background: url(../assets/images/menuItem10bg.png) no-repeat;
        background-size: 100% 100%;
        margin:  0 auto;
        img{
          width: 100%;
...
.top-button {
  ...
  .sound {
    background: url(../assets/images/soundTop8.png);
