 ...
 * @LastEditTime: 2019-09-26 17:57:25
                ...
                <vuedraggable class="curRed" v-model="appleLetter1" :options="option" :move="move">
                  <transition-group>
                    <div :key="appleLetter1[0].name" :id="appleLetter1[0].name" class="move">
                      <img src="../assets/images/apple-red-second.png" />
                ...
                <vuedraggable class="curGreen" v-model="appleLetter2" :options="option2" :move="move">
                  <transition-group>
                    <div :key="appleLetter2[0].name" :id="appleLetter2[0].name" class="move">
                      <img src="../assets/images/apple-green-second.png" />
  ...
  export default {
    ...
    data() {
      return {
        ...
        imageUrlA: require("../assets/images/A.png"),
        imageUrlAa: require("../assets/images/aa.png"),
        appleLetter1: [{
          flag: "true",
          name: "red"
        }],
