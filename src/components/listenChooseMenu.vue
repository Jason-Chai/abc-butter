<template>
  <div class="di main-wrap listenchooseM">
    ...
    <div class="top-button">
      <a class="refresh" @click="refresh()">
        <img src="../assets/images/replay11.png" alt />
      </a>
      <div class="titleList">
        <img src="../assets/images/listenChoose.png" alt />
      </div>
      <div class="sound">
        <!-- <div class="audio">
        ...
        <div class="sound-button">
          ...
          <div class="volume" @click="startMutedOrNot">
            <img v-if="audio.muted == true" src="../assets/images/say11-off.png" alt />
            <img v-else src="../assets/images/say11.png" alt />
          </div>
        </div>
      </div>
      <router-link :to="routerUrl" class="next-button" replace>
        <img src="../assets/images/next11.png" alt />
      </router-link>
      <div class="nav">
        <img @click="showNavList" src="../assets/images/menu11.png" class="menu" alt />
        <div :class="navListShow ? 'navListOn':'navListOff'" class="navList">
           <div v-for="(item,index) in menuList" :key="index">
                <router-link :to="item.routerUrl"> <img :src="item.imgSrc" /></router-link>
          </div>
        </div>
      </div>
    </div>
...
<style lang="less" scoped>
  ...
  .nav {
    ...
    .navList {
      ...
      top: 187 / @rem;
      right: 0;
      background: url(../assets/images/menuBg11.png) no-repeat;
  ...
  .top-button {
    ...
    .sound {
      background: url(../assets/images/soundTop11.png);
