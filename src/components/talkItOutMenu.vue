<template>
  <div class="di main-wrap tioM">
    ...
    <div class="ani-bg"><img src="../assets/images/commonImg/anibg4.png"></div>
    <div class="ani-bg2"><img src="../assets/images/commonImg/anibg5.png"></div>
    <div class="tips-button"><img src="../assets/images/commonImg/tips.png"></div>
    <div class="menu-content">
        <!--标题-->
        <div class="titleList">
          <img src="../assets/images/commonImg/talkItOut.png" alt />
        </div>
