  ...
  <div class="di main-wrap vMN">
    ...
    <div class="top-button">
      <a class="refresh" @click="refresh()">
        <img src="../assets/images/replay12.png" alt />
      </a>
      <div class="titleList">
        <img src="../assets/images/vocabulary_n.png" alt />
      </div>
      <div class="sound">
        <div class="sound-button">
          ...
          <div class="volume" @click="startMutedOrNot">
            <img v-if="audio.muted == true" src="../assets/images/say12-off.png" alt />
            <img v-else src="../assets/images/say12.png" alt />
          </div>
        </div>
      </div>
      <router-link :to="routerUrl" class="next-button" replace>
        <img src="../assets/images/next12.png" alt />
      </router-link>
      <div class="nav">
        <img @click="showNavList" src="../assets/images/menu12.png" class="menu" alt />
