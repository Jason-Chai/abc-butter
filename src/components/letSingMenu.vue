  ...
  <div class="di main-wrap singM">
    ...
    <div class="top-button">
      <a class="refresh" @click="refresh()">
        <img src="../assets/images/replay9.png" alt>
      </a>
      <div class="titleList">
        <img src="../assets/images/letSingT.png" alt>
      </div>
      <div class="sound">
        <!-- <div class="audio">
        ...
        <div class="sound-button">
          ...
          <div class="volume" @click="startMutedOrNot">
            <img v-if="audio.muted == true" src="../assets/images/say8-off.png" alt>
            <img v-else src="../assets/images/say8.png" alt>
          </div>
        </div>
      </div>
      <router-link :to="routerUrl" class="next-button" replace>
        <img src="../assets/images/next9.png" alt>
      </router-link>
      <div class="nav">
        <img @click="showNavList" src="../assets/images/menu9.png" class="menu" alt>
...
.nav {
  ...
  .navList {
      ...
      top: 187 / @rem;
      right: 0;
      background: url(../assets/images/menuBg9.png) no-repeat;
...
.top-button {
  ...
  .sound {
    background: url(../assets/images/soundTop3.png);
